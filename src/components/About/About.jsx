...
export default function About() {
  return (
    <>
      ...
      <p>Desarrollador web frontend apasionado por desarrollar interfaces de usuario entendibles, fáciles de usar y eficientes. Con conocimientos en HTML, CSS, Javascript y con capacidades de crear aplicaciones en React JS, adicionalmente con conocimientos en NodeJS, MongoDB y Express, entre otros.
      <br /><br />
      Me encanta la buena comida, los videojuegos y pasar buenos momentos con mis amigos y familia.</p>
